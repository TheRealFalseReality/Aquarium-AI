...
class StockingRecommendationOptions {
  ...
  StockingRecommendationOptions({required this.additionalNotes});
}
...
class StockingRecommendationOptionsDialog extends StatefulWidget {
  ...
  @override
  State<StockingRecommendationOptionsDialog> createState() =>
      _StockingRecommendationOptionsDialogState();
}

class _StockingRecommendationOptionsDialogState
    extends State<StockingRecommendationOptionsDialog> {
    ...
    return AlertDialog(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'e.g., "I want to add bottom dwellers" or "Looking for colorful schooling fish"',
      ...
      actions: [
        ...
        ElevatedButton.icon(
          ...
          label: Text(
            isCompatibility ? 'Analyze Compatibility' : 'Get Recommendations',
          ),
        ),
      ],
    );
