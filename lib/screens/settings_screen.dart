...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget _buildFounderSupportCard(BuildContext context) {
    ...
    return _buildMenuCard(
      ...
      onTap: () => _showFounderSupportDialog(isFounder),
    );
  }

  void _showFounderSupportDialog(bool isFounder) {
    final l10n = AppLocalizations.of(context)!;
    final founderColor = AquaThemeColors.founderColor(context);

    AnalyticsService.logScreenView(screenName: 'founder_support_settings');
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.diamond, color: founderColor),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Text(
                          l10n.founderSupport,
                ...
                // Content
                Expanded(
                  child: _buildFounderSupportContent(
                    isFounder,
                    setDialogState,
                  ),
                ),
  ...
  Widget _buildFounderSupportContent(
    bool isFounder,
    StateSetter setDialogState,
  ) {
    final l10n = AppLocalizations.of(context)!;
    ...
    if (isFounder) {
      // Founder content: customization options
      return ListView(
        padding: const EdgeInsets.all(16),
        children: [
          // Status badge
          Container(
            ...
            child: Row(
              children: [
                Icon(Icons.diamond, color: founderColor, size: 20),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    l10n.founderSupportDesc,
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      color: founderColor,
          ...
          Card(
            clipBehavior: Clip.antiAlias,
            child: ListTile(
              leading: Icon(Icons.dashboard_customize, color: founderColor),
          ...
          Card(
            clipBehavior: Clip.antiAlias,
            child: ListTile(
              leading: Icon(Icons.menu_open, color: founderColor),
            ...
            child: Column(
              children: [
                ...
                _buildFeatureBullet(
                  ...
                  l10n.featureCustomizeCards,
                  founderColor,
                ),
                const SizedBox(height: 8),
                _buildFeatureBullet(
                  Icons.menu_open,
                  l10n.featureCustomizeSidebar,
                  founderColor,
                ),
                const SizedBox(height: 8),
                _buildFeatureBullet(
                  Icons.speed,
                  l10n.featureHigherLimits,
                  founderColor,
                ),
                const SizedBox(height: 8),
                _buildFeatureBullet(
                  Icons.block,
                  l10n.featureRemoveAds,
                  founderColor,
                ),
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: Text(l10n.unlockAllFeatures),
          ...
          Opacity(
            ...
            child: Card(
              ...
              child: ListTile(
                leading: Icon(Icons.dashboard_customize, color: founderColor),
                title: Text(l10n.customizeWelcomeCards),
                subtitle: Text(l10n.founderFeatureLocked),
                trailing: Icon(Icons.lock, size: 16, color: founderColor),
                onTap: () {
                  Navigator.of(context).pop();
                  showRemoveAdsDialog(context);
                },
