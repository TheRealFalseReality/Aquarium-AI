    ...
    showDialog<void>(
      ...
      builder: (alertContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(l10n.providerMismatchDetails),
            ...
            const SizedBox(height: 8),
            Text(l10n.providerMismatchConsequence),
          ],
        ),
        actions: [
          TextButton(
  ...
  Future<void> _clearApiKey(
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(l10n.clearApiKey),
        content: Text(l10n.clearApiKeyConfirm(label)),
        actions: [
          TextButton(
    ...
    if (context.mounted) {
      context.showAccessibleMessage(l10n.keyCleared(label));
    }
  }
            ...
            child: Container(
              ...
              child: RemoteConfigService.freeAiEnabled
                  ...
                  : ListTile(
                      ...
                      title: Text(
                        l10n.freeAITierUnavailableTitle,
                        style: Theme.of(context).textTheme.labelMedium?.copyWith(
                              color: Colors.red.shade700,
                              fontWeight: FontWeight.bold,
                            ),
                      ...
                      subtitle: Text(
                        l10n.freeAITierUnavailableBody,
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                              color: Colors.red.shade700,
                            ),
                      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            !onFreeTier
                ? l10n.chatHistoryLimitDescription
                : l10n.chatHistoryFreeTierDescription(RemoteConfigService.freeTierChatHistoryLimit, maxChatHistoryLimit),
            style: Theme.of(context).textTheme.bodySmall?.copyWith(
              color: Theme.of(context).colorScheme.onSurfaceVariant,
            ),
          ),
  ...
  Widget _buildGeminiSettings([StateSetter? setDialogState, bool? forTextUseCase]) {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _buildApiKeyGuide(
          title: l10n.howToGetGoogleAIKey,
          children: [
        ...
        _buildApiKeyGuide(
          ...
          children: [
            Text(l10n.viewAvailableModelsFreeTier),
            InkWell(
    ...
    return Column(
      ...
      children: [
        ...
        _buildApiKeyGuide(
          ...
          children: [
            Text(l10n.viewAvailableModelsUsage),
            InkWell(
          ...
          children: [
            ...
            Theme(
              ...
              child: ExpansionTile(
                ...
                title: Text('Google Gemini', // brand name
                    style: Theme.of(context).textTheme.titleSmall?.copyWith(
                          fontWeight: FontWeight.bold,
                          color: Colors.blue,
                        )),
