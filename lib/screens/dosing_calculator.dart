...
class _DosingCalculatorState extends ConsumerState<DosingCalculator> {
  ...
  // ── Add product dialog (inline, no navigation to settings) ───────────────
  /// Shows a dialog to add a new dosing product preset.
  /// After saving, the new preset is automatically selected.
  void _showAddProductDialog(BuildContext parentCtx) {
