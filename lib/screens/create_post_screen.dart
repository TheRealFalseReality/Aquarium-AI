...
class _CreatePostScreenState extends ConsumerState<CreatePostScreen> {
  ...
  Future<void> _submit() async {
    ...
    if (_includeTankInfo && _selectedTankId != null) {
      ...
      // best-available image URL (user URL only — bundled fish images are local
      // assets and cannot be served as community post images).
      final inhabitantsList = tank.inhabitants.map((i) {
        // Only include the image URL when it is a real remote URL supplied by
        // the user.
