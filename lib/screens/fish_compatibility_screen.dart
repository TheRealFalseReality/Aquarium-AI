...
class FishCompatibilityScreenState
  ...
  List<Widget> _buildFishGridWithAds(FishCompatibilityState providerState) {
    ...
    if (kIsWeb) {
      ...
      while (fishIndex < totalFish) {
        ...
        slivers.add(
          SliverPadding(
            padding: EdgeInsets.fromLTRB(16, startIndex == 0 ? 16 : 0, 16, 0),
            sliver: SliverGrid(
              gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                maxCrossAxisExtent: 210,
                childAspectRatio: 3 / 4,
        ...
        if (shouldShowAd) {
          slivers.add(
            SliverPadding(
              ...
              sliver: SliverToBoxAdapter(child: _buildNativeAdCard()),
            ),
          );
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    final double bottomBarHeight = providerState.selectedFish.isNotEmpty
        ? 84.0
        : 0.0;
  ...
  Widget _buildBottomBar(
    FishCompatibilityState provider,
    FishCompatibilityNotifier notifier,
    bool isDisabled,
  ) {
    final l10n = AppLocalizations.of(context)!;
                      ...
                      return ClipRRect(
                        ...
                        child: CachedNetworkImage(
                          ...
                          errorWidget: (c, url, error) => Container(
                            ...
                            child: Icon(Icons.error, color: cs.error, size: 20),
                          ),
                        ),
                      );
                    },
                      ...
                      : () async {
                          ...
                          AnalyticsService.logFeatureUsed(
                            ...
                            parameters: {
                              ...
                              'selected_fish_count':
                                  provider.selectedFish.length,
                              'has_fish_selected':
                                  provider.selectedFish.isNotEmpty
                                  ? 'true'
                                  : 'false',
                            },
                          );
                          ...
                          final speciesSelections =
                              await _showSpeciesSelectionDialog(
                                provider.selectedFish,
                              );
                          ...
                          final debugHideAds =
                              kDebugMode &&
                              ref.read(appSettingsProvider).debugHideAds;
