...
String buildAutomationScriptPrompt(String description) {
  ...
  return '''
    ...
    Respond with a JSON object with this exact structure:
    {
      ...
      "explanation": "A Markdown-formatted explanation of the script that concludes with subtle links to our store: [Shop AquaPi]($aquapiStoreUrl) and the Home Assistant website: [Learn more about Home Assistant](https://www.home-assistant.io/).",
